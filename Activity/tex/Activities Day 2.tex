...
\begin{enumerate}
	\item Insert \mintinline{tex}{\usepackage{hyperref}} in your preamble.
	\item Also load \mintinline{tex}{\usepackage{todonotes}}  just after \mintinline{tex}{\usepackage{hyperref}}.
...
\begin{enumerate}
	...
	\item Define bibliography style just after  \mintinline{tex}{\usepackage{natbib}} with \\ \mintinline{tex}{\bibliographystyle{plainnat}} command.
...
\title[Proposal]{Machine Learning Algorithm for Predicting Student's Performance.}
...
\item Add one frame with some contents under each section. \\ \textbf{Hints}. You may use \mintinline{tex}{\begin{itemize} \item .. \end{itemize}} environment to create list of item.
