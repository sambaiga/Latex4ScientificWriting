...
\begin{center}
{\Large \textbf{ {\color{green} \textbf{Workshop On LaTeX for Scientific Writing} }  }}
\end{center}
...
\begin{enumerate}
  ...
  \item Why is it not possible to use \chapter {} , in this document?.
\end{enumerate}
...
Experiment with the section cross-reference in the Activity.tex 
